...
2. 加了r8125的2.5G网卡驱动V9.009.01， r8152的USB2.5G网卡驱动V2.16.1。开机启动即可识别。群晖目前V7.X的内核只能支持螃蟹的2.5G网卡，内核太老，不支持Intel的i255之类的2.5G网卡驱动。 在这种i225网口小主机上，建议群晖直通螃蟹的USB 2.5G网卡， 是当前唯一硬件直通2.5G的方案。
